...
let
  ...
  version-info = {
    ...
    "aseprite-m96" = {
      rev = "223763e26f0e1dbfcdb0564b05a3a55c1cefe5a4";
      sha256 = "sha256-xXSP+NJJkobPxKbp+uMAbSjwe2D5pCArTt2WIRNZ9Tk=";
    };
    "aseprite-m102" = {
...
stdenv.mkDerivation {
  ...
  nativeBuildInputs = [
    python3
    ninja
    (if (version == "aseprite-m71") then gnOld else gn)
  ];
  ...
  patches = [
    ./0001-remove-python-2-dependency.patch
  ];
