...
let
  skia = callPackage ./skia.nix { version = "aseprite-m71"; };
in
stdenv.mkDerivation rec {
  pname = "aseprite";
  version = if unfree then (if beta then "1.3-rc4" else "1.2.40") else "1.1.7";
  ...
  src = fetchFromGitHub {
    ...
    sha256 =
      if !unfree
      then "0gd49lns2bpzbkwax5jf9x1xmg1j8ij997kcxr2596cwiswnw4di"
      else if beta
      then "sha256-VX1jO+Umime29H3MbNFHH44wE62WO7TlsAL31JirTi0="
      else "sha256-SDW/ImLf+mrFgyjTcO4dYj8gRtV1HcxAabKw1pM/1ps=";
  };
